...
function DepositoSelect() {
    const { depositos, selectDeposito, setSelectDeposito } = useProductosLista()
    return (
        <FormControl fullWidth>
            <InputLabel id="deposito-select-label">Seleccione depósito</InputLabel>
            <Select value={selectDeposito} onChange={({ target }) => setSelectDeposito(Number(target.value))} label="Depósito">
